...
![svchost](http://mike-ward.net/content/images/blog/FridayLinks52_570F/svchost.gif)
...
[MaxTo](http://www.maxto.net/using) – MaxTo splits your screen into rectangular regions. Every time a window is maximized, MaxTo intercepts the event, and instead moves the window to fit inside one of these regions. I had considered adding this functionality to [FreeSnap](http://mike-ward.net/freesnap) at one time. 
