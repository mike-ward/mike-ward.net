...
2008-08-07T13:33:36
**Update**: I've discovered my solution here is flawed. See [Desk Drive 1.4.4 Released](http://mike-ward.net/blog?p=49b43621-5fb9-4809-9faf-278cd2d7917e) for details.
...
The RCW gives the Shell32 object the appearance of a .Net object. No messy reference counting or **QueryInterface()** calls. This is how I originally wrote the code in [Desk Drive](http://mike-ward.net/blog?p=9992c4a1-9581-426a-acc0-7babb5284c83) and it worked great on Vista, the platform I developed it on.
